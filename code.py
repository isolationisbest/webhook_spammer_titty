...
web = Write.Input(f"[TITTY SPAMMER] Webook: ", Colors.rainbow, interval=0.0025)

#webhook username
rando=["nigga","fucked by prochify","get better","get a job"]

#webhook message
#spam=input(f"{a}[{c}ECSTACY{b}{a}]{b} {c}Message{a}: ")
spam = Write.Input(f"[TITTY SPAMMER] Message: ", Colors.rainbow, interval=0.0025)
...
if __name__ == "__main__":
    os.system('cls & title Titty Webhook Spammer ')
    logo = """
┌┬┐┬┌┬┐┌┬┐┬ ┬  ┌─┐┌─┐┌─┐┌┬┐┌┬┐┌─┐┬─┐
 │ │ │  │ └┬┘  └─┐├─┘├─┤││││││├┤ ├┬┘
 ┴ ┴ ┴  ┴  ┴   └─┘┴  ┴ ┴┴ ┴┴ ┴└─┘┴└─
